...
--
-- Host: localhost:3306
-- Generation Time: Feb 23, 2024 at 09:50 AM
...
(5, '2023_12_24_121504_create_permission_tables', 1),
(6, '2023_12_30_065158_create_posts_table', 1),
(7, '2023_12_30_065936_create_media_table', 1),
(8, '2023_12_30_070020_create_comments_table', 1),
(9, '2023_12_30_070434_create_likes_table', 1),
(10, '2023_12_30_070750_create_shares_table', 1),
(11, '2024_01_09_094436_create_replycomments_table', 1);
...
(1, 'access_admin', 'web', '2024-02-23 02:20:42', '2024-02-23 02:20:42'),
(2, 'access_user', 'web', '2024-02-23 02:20:42', '2024-02-23 02:20:42');
...
(1, 'admin', 'web', 1, '2024-02-23 02:20:42', '2024-02-23 02:20:42'),
(2, 'user', 'web', 1, '2024-02-23 02:20:42', '2024-02-23 02:20:42');
...
CREATE TABLE `shares` (
  ...
  `post_id` bigint UNSIGNED NOT NULL,
  `user_id` bigint UNSIGNED NOT NULL,
  `privacy` enum('public','friends','only_me') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `replycomments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `replycomments_comment_id_foreign` (`comment_id`),
  ADD KEY `replycomments_user_id_foreign` (`user_id`);
...
--
ALTER TABLE `replycomments`
  ADD CONSTRAINT `replycomments_comment_id_foreign` FOREIGN KEY (`comment_id`) REFERENCES `comments` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `replycomments_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
