        ...
        <div class="chat-friends">
            <ul class="chat-users">
                <li>
                    ...
                    <span class="user-name">Quang foden</span>
                </li>
                <li>
                    <div class="author-thmb">
                        ...
                        <li class="me">
                            ...
                            <div class="notification-event">
                                <span class="chat-message-item">
                                    HI, Jack i have faced a problem with your software. are you available now, when i
                                    install this i have to received an error.
                                </span>
