<template>
    <div class="topbar stick" style="">
        ...
        <div class="top-area">
            ...
            <ul class="setting-area">
                ...
                <li>
                    ...
                    <div class="dropdowns ps-container ps-theme-default ps-active-y"
                        data-ps-id="b4922213-281c-5648-617d-74853906270e">
                        ...
                        <div class="ps-scrollbar-y-rail" style="top: 0px; height: 340px; right: 0px;">
                            <div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 323px;"></div>
                        </div>
                    </div>
                </li>
                <li>
                    ...
                    <div class="dropdowns ps-container ps-theme-default ps-active-y"
                        data-ps-id="f7b7fff5-1fd0-2a5e-71c6-9b78e8b85b14">
                ...
                <li>
                    ...
                    <div class="dropdowns ps-container ps-theme-default ps-active-y"
                        data-ps-id="e2acc539-2f47-0954-076e-820b21f8b1a3">
                        ...
                        <ul class="drops-menu">
                            ...
                            <li>
                                <a class="show-mesg" href="#" title="">
                                    ...
                                    <div class="mesg-meta">
                                        <h6>Jhon doe</h6>
                                        <span><i class="ti-check"></i> We’ll have to check that at the office and see if the
                            ...
                            <li>
                                <a class="show-mesg" href="#" title="">
                                    ...
                                    <div class="mesg-meta">
                                        <h6>Andrew</h6>
                                        <span> <i class="fa fa-paperclip"></i>Hi Jack's! It’s Diana, I just wanted to let
                                            you know that we have to reschedule..</span>
                                        <i>2 min ago</i>
                                    </div>
                                </a>
                            </li>
                ...
                <li><a href="#" title="Languages" data-ripple=""><i class="fa fa-globe"></i><em>EN</em></a>
                    <div class="dropdowns languages ps-container ps-theme-default"
                        data-ps-id="65269e93-e35b-f119-71fc-3c4da533a8ec">
                ...
                <li><a href="#" title="Help" data-ripple=""><i class="fa fa-question-circle"></i></a>
                    <div class="dropdowns helps ps-container ps-theme-default"
                        data-ps-id="d4d4f290-67f2-9368-daf3-a667c026bb37">
            ...
            <span class="ti-settings main-menu" data-ripple=""><span class="ripple"><span class="ink"
                        style="height: 18px; width: 18px; background-color: rgb(94, 126, 167); top: -0.5px; left: 2.71875px;"></span></span></span>
        </div>
        <nav>
            <ul class="nav-list">
